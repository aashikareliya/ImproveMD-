...
async def connect_to_device(mac_address, retries=3):
    ...
    while True:  # Continuous loop to keep the connection alive
                    ...
                    if client.is_connected:
                        ...
                        try:
                            while client.is_connected:
                                await asyncio.sleep(1)  # Keep the connection active
        ...
        print("Failed to connect after multiple attempts. Retrying in 5 seconds...")
